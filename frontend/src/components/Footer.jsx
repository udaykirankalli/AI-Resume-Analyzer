        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-sky-300 to-violet-400">
        ...
        Terms of Service
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/kalliudaykiran/" className="text-slate-400 transition-colors hover:text-violet-200">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://github.com/UdaykiranKalli" className="text-slate-400 transition-colors hover:text-violet-200">
                <Github className="h-5 w-5" />
              </a>
               <a href="https://www.instagram.com/phonalynx/" className="text-slate-400 transition-colors hover:text-violet-200">
