    ...
    <header className="fixed inset-x-0 top-0 z-50 px-3 pt-3 sm:px-6">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between rounded-2xl border border-white/15 bg-[#11152d]/70 px-4 shadow-[0_16px_50px_rgba(4,7,24,0.35)] backdrop-blur-2xl sm:px-5">
        <Link to="/" className="flex items-center gap-2.5 text-white">
          <span className="grid h-9 w-9 place-items-center rounded-xl border border-white/15 bg-gradient-to-br from-cyan-300 to-sky-400 text-slate-950"><FileText className="h-5 w-5" /></span>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button asChild className="rounded-xl bg-cyan-300 px-4 text-slate-950 hover:bg-cyan-200"><Link to="/register">Get started</Link></Button>
        </div>
      </div>
    </header>
  );
