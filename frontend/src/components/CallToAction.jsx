...
export function CallToAction() {
  return <section className="bg-[#0b1026] px-6 pb-24 text-white"><div className="mx-auto max-w-6xl rounded-[2rem] border border-cyan-200/15 bg-gradient-to-br from-cyan-400/20 via-sky-400/10 to-blue-300/10 px-7 py-14 text-center shadow-[0_25px_80px_rgba(4,7,24,0.38)] backdrop-blur-xl sm:px-14">
    <span className="mx-auto grid h-12 w-12 place-items-center rounded-2xl border border-white/15 bg-white/10 text-cyan-100"><Sparkles className="h-5 w-5" /></span>
